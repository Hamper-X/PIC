...
;troc todas as palavras que sejam botao por portA
#DEFINE	BOTAO	PORTA,2	;PORTA DO BOTÃO
					; 0 -> PRESSIONADO
					; 1 -> LIBERADO
;portB define o que tem
;tris: libera se A ou B vai ser entrada ou a saida 
...
MAIN
	...
	BTFSC	BOTAO		;O BOTÃO ESTÁ PRESSIONADO?
		;Se o Botão esta prescido: Se um bit esta prescionado
		;se for zero, pula ma linha, se for 1 continua 
